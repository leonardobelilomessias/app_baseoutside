...
export function AppRoutes(){
    ...
    return(
        <Navigator screenOptions={{ tabBarShowLabel:false,  }}>
            ...
            <Screen name='Search' component={Home} options={{tabBarIcon:({color,focused})=>(<AntDesign name="search1" size={24} color={focused?colors.green['500']:color} />), headerTitle:()=>(<HeaderHome/>), headerRight:()=>(<MessageIcon/>),headerRightContainerStyle:{ marginRight:15}}}/>
